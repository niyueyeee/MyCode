...
<div class="row" style="width: 1210px; margin: 0 auto;">
    ...
    <c:forEach var="i" items="${pageBean.productList}">
        <div class="col-md-2" style="height:230px;">
            ...
            <p>
                <font color="#FF0000">商城价：&yen;${i.shop_price}</font>
            </p>
        </div>
    </c:forEach>
</div>
...
<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
    <ul class="pagination" style="text-align: center; margin-top: 10px;">
        ...
        <c:forEach var="currentPage" begin="1" end="${pageBean.totalPage}" step="1">
            ...
            <c:if test="${currentPage != pageBean.currentPage}">
                <li><a href="${pageContext.request.contextPath}/page?currentPage=${currentPage}">${currentPage}</a>
                </li>
            </c:if>
        </c:forEach>
        <%--下一页--%>
