...
public class OrderServiceImpl implements OrderService {
    ...
    public void add(Order order) {
        ...
        for (Cart cart : cartList) {//商家ID 库存ID  数量
            ...
            List<cn.itcast.core.pojo.order.OrderItem> orderItemList = cart.getOrderItemList();
            for (cn.itcast.core.pojo.order.OrderItem orderItem : orderItemList) {

                //ID
                orderItem.setId(idWorker.nextId());

                cn.itcast.core.pojo.item.Item item = itemDao.selectByPrimaryKey(orderItem.getItemId());
                //商品ID
        ...
        //保存日志表 (支付表)
        cn.itcast.core.pojo.log.PayLog payLog = new cn.itcast.core.pojo.log.PayLog();
        //ID
