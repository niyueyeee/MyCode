...
public class Stream08 {
    public static void main(String[] args) {
        ...
        Stream.of(provinces).filter(s -> s.length() == 3).forEach(System.out::println);
        ...
        System.out.println(Arrays.toString(Stream.of(provinces).filter(s -> !s.contains("省")).toArray(String[]::new)));
    }
}
