                            ...
                            <table id="dataList"
                                ...
                                <%--
                                    c:foreach :循环标签
                                        ...
                                        var：遍历中的每一个对象
                                --%>
                                <c:forEach items="${pageInfo.list}" var="product" varStatus="v">
                                    <tr>
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            条数据。 每页 <select onchange="gotoPage(1)" id="pageSize" class="form-control">
...
<script type="text/javascript">
    ...
    function gotoPage(page) {
        ...
        window.location.href = "${pageContext.request.contextPath}/product/findAll3?pageNum=" + page + "&pageSize=" + pageSize;
    }
    ...
    function delOne(id) {
        if (confirm("您确定要删除吗？")) {
            window.location.href = "${pageContext.request.contextPath}/product/delOne?id=" + id;
        }
    }
